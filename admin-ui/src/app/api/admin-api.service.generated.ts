...
export class AdminApiPostApiClient {
     ...
     * @return Success
     */
    updatePost(id: string, body?: CreateUpdatePostRequest | undefined): Observable<PostDto> {
        let url_ = this.baseUrl + "/api/admin/post/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processUpdatePost(response: HttpResponseBase): Observable<PostDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    createPost(body?: CreateUpdatePostRequest | undefined): Observable<PostDto> {
    ...
    protected processCreatePost(response: HttpResponseBase): Observable<PostDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    sendForApprovalPost(id: string): Observable<void> {
        let url_ = this.baseUrl + "/api/admin/post/send-to-approve/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("patch", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSendForApprovalPost(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSendForApprovalPost(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processSendForApprovalPost(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    rejectPost(id: string, body?: RejectPostRequest | undefined): Observable<void> {
     ...
     * @return Success
     */
    backToDraft(id: string): Observable<void> {
        let url_ = this.baseUrl + "/api/admin/post/back-to-draft/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("patch", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBackToDraft(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBackToDraft(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processBackToDraft(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class AdminApiRoleApiClient {
    ...
    createRole(body?: CreateUpdateRoleRequest | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/admin/role/create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getPermissions(roleId: string | null): Observable<PermissionDto> {
    ...
    protected processGetPermissions(response: HttpResponseBase): Observable<PermissionDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    updatePermissions(body?: PermissionDto | undefined): Observable<void> {
...
export class AdminApiSeriesApiClient {
     ...
     * @return Success
     */
    getSeries(id: string): Observable<SeriesDto> {
    ...
    protected processGetSeries(response: HttpResponseBase): Observable<SeriesDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class AdminApiUserApiClient {
     ...
     * @return Success
     */
    getUsersPaging(keyword?: string | null | undefined, pageIndex?: number | undefined, pageSize?: number | undefined): Observable<UserDtoPagedResult> {
    ...
    protected processGetUsersPaging(response: HttpResponseBase): Observable<UserDtoPagedResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    changePassWord(body?: ChangeMyPasswordRequest | undefined): Observable<void> {
     ...
     * @return Success
     */
    assignRoles(id: string | null, body?: string[] | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/admin/user/assign-users/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
...
export class RejectPostRequest implements IRejectPostRequest {
    reason!: string;

    constructor(data?: IRejectPostRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): RejectPostRequest {
        data = typeof data === 'object' ? data : {};
        let result = new RejectPostRequest();
        result.init(data);
        return result;
    }
